...
/*$stmt = $conn->prepare("INSERT INTO reponse (msg, dateMessage,id, idM) VALUES ('s,'2024-04-27T14:10:31.686Z', ,2147483665
)");
 $stmt->execute()*/
...
function addComment($newComment, $conn) {
    $stmt = $conn->prepare("INSERT INTO reponse (msg, dateMessage, id, idM) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssii", $newComment['content'], $newComment['dateMessage'], $newComment['id_user'], $newComment['idM']);
    return $stmt->execute();
}
?>
